   ...
   <%@ include file="header.jsp"%>
    ...
    <div class="container">
      <div class="bg-faded p-4 my-4">
        ...
        <hr class="divider">
		<form name="form" action="RegistrationServlet" method="post" onsubmit="return validateRegistration(form);">
          <div class="row">
           <div class="form-group col-lg-4">
             ...
             <div class="form-group col-lg-4">
              <label class="text-heading">Date of Birth</label>
              <input type="date" name="address" id="address" class="form-control">
            </div>
            <div class="form-group col-lg-4">
            ...
            <div class="form-group col-lg-4">
              ...
              <input type="password" name="password" id="password" class="form-control" 
               title="Password Contains atleast one digit,lower case letter a-i and any sepcial character(@#,$,%,&).">
